...
public class GameRecordApiTest {
    ...
    void shouldCreateANewGameRecord() {
        ...
        GameRecord newGameRecord = new GameRecord(null, 1L, 1L, true, false, false, now);
        ...
        assertThat(gameDateTime).isNotNull();
        assertThat(gameDateTime).isBeforeOrEqualTo(LocalDateTime.now());
    }
}