...
public class TeamApiTest {
    ...
    void shouldReturnATeamWithAKnownId() {
        ...
        assertThat(teamName).isEqualTo("unit_test_game_01");
        String teamMember01 = documentContext.read("$.teamMember_01");
        assertThat(teamMember01).isEqualTo("unit_test_team_member_01");
        String teamMember02 = documentContext.read("$.teamMember_02");
        assertThat(teamMember02).isEqualTo("unit_test_team_member_02");
        String teamMember03 = documentContext.read("$.teamMember_03");
        assertThat(teamMember03).isEqualTo("unit_test_team_member_03");
    }

    @Test
    void shouldNotReturnATeamWithAnUnknownId() {
        ResponseEntity<String> response = restTemplate
        .getForEntity("/teams/100000", String.class);
