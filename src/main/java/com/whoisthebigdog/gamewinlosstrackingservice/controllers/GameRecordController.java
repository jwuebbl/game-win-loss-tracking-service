...
public class GameRecordController {
    ...
    @GetMapping()
    public ResponseEntity<List<GameRecord>> findAllGames() {
        List<GameRecord> gameRecords = (List<GameRecord>) gameRecordRepository.findAll();
    ...
    private ResponseEntity<Void> createGame(@RequestBody GameRecord newGameRecordRequest, UriComponentsBuilder ucb) {
        System.out.println(newGameRecordRequest);
